...
urlpatterns = [
    ...
    path('contactus', views.contactus_view,name='contactus'),  # i will work on later
    ...
    path('updation-add-from-cart/<int:pk>', views.updation_add_from_cart_view,name='updation-add-from-cart'),
     path('updation-dec-from-cart/<int:pk>', views.updation_dec_from_cart_view,name='updation-dec-from-cart'),
